  ...
  return (
    <section className="py-16 md:py-24 bg-card">
      <div className="container mx-auto max-w-screen-xl px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold font-headline mb-4">Lineup Golden Epiphany</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {featuredArtists.map((artist) => (
            <Card key={artist.id} className="overflow-hidden group transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-2 transform">
