    ...
    return (
        <section className="py-16 md:py-24 bg-background">
            <div className="container mx-auto max-w-screen-lg px-4 text-center">
                <h2 className="text-3xl md:text-4xl font-bold uppercase font-headline mb-4 neon-glow-accent">
                ...
                <div className="rounded-lg overflow-hidden border-2 border-accent/50 p-1 md:p-2 shadow-2xl shadow-accent/20 animate-neon-pulse">
                     <iframe 
