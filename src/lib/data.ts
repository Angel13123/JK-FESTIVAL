...
export const artists: Artist[] = [
  {
    id: '1',
    name: 'Aureo',
    description: 'El pionero del R&B dorado con ritmos que definen una generación.',
  ...
  },
  {
    id: '2',
    name: 'Epiphany Beats',
    description: 'El DJ que transforma la noche con sus revelaciones electrónicas y urbanas.',
  ...
  },
  {
    id: '3',
    name: 'Mako Verse',
    description: 'Narrador de la calle, sus rimas son un universo de historias crudas y reales.',
  ...
  },
  {
    id: '4',
    name: 'Luz Dorada',
    description: 'La voz del soul y pop que ilumina el escenario con su energía radiante.',
  ...
  },
   {
    id: '5',
    name: 'Golden Cipher',
    description: 'Maestro de las líricas encriptadas y los ritmos hipnóticos.',
    imageUrl: PlaceHolderImages.find(p => p.id === 'artist5')?.imageUrl || '',
    day: 1,
    stage: 'Urban Stage',
    time: '23:30',
  },
  {
    id: '6',
    name: 'DJ Solaris',
    description: 'Sus sets son pura energía solar, una explosión de bass y melodías.',
    imageUrl: PlaceHolderImages.find(p => p.id === 'artist6')?.imageUrl || '',
    day: 1,
    stage: 'Electronic Stage',
    time: '21:00',
  },
